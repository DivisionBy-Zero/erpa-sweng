...
class GCPApi {
    public interface GameInterface {
        ...
        @POST("/games/participants/{gameUuid}")
        Call<PlayerJoinGameRequest> updateGamePlayerJoinRequest(@Path("gameUuid") String gameUuid, @Header("Authorization") String authorizationHeader, @Body PlayerJoinGameRequest request);
