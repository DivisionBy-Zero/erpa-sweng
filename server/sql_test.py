...
class TestSQLQueries(unittest.TestCase):
    ...
    def test_db_queries_works(self, session):
        ...
        # self.assertEqual([game2, game1, game], get_game_list(session, {}, ["asc_max_player"]).all())
        # self.assertEqual([game, game1, game2], get_game_list(session, {}, ["dsc_max_player"]).all())